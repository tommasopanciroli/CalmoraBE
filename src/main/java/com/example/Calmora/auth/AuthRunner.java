...
public class AuthRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        Optional<AppUser> normalSeller = appUserService.findByUsername("psychologist");
        if (normalUser.isEmpty()) {
            appUserService.registerUser("psychologist", "psychologistpws", Set.of(Role.ROLE_PSYCHOLOGIST));
        }
